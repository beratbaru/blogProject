...
<?php else: ?>
    ...
    <div id="menuDropdown" class="md:hidden absolute right-0 w-48 bg-white shadow-lg rounded-lg py-2 mt-2 hidden">
        <a href="<?php echo e(url('profile')); ?>" class="block px-6 py-3 hover:bg-gray-100">
...
<section class="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        <div class="bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-700">
            ...
            <div class="px-6 py-8">
                <form action="<?php echo e(route('profile.update', $profile['id'])); ?>" method="POST" class="space-y-6">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/profile.blade.php ENDPATH**/ ?>